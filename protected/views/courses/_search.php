<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->textFieldRow($model,'owner_user_id',array('class'=>'span5')); ?>
	...
	<?php echo $form->textFieldRow($model,'price_by',array('class'=>'span5','maxlength'=>15)); ?>

	<?php echo $form->textFieldRow($model,'price',array('class'=>'span5')); ?>

	<?php echo $form->textFieldRow($model,'previous_course_id',array('class'=>'span5')); ?>
